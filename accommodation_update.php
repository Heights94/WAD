    ...
    <body>
        ...
        <div id="register">
            <form action="mysql.php" method="post" enctype="multipart/form-data">
                <label>Area</label><input type="text"  name="area" value="<?php echo $assoc['Area']; ?>" oninput="data_input(this)"/> <br/>
                <label>Address</label><input   name="address" value="<?php echo $assoc['Address']; ?>" oninput="data_input(this)"/> <br/>
                ...
                <label>Weekly rate (£)</label><input   name="rate" value="<?php echo $assoc['Rate']; ?>" maxlength="7" oninput="data_input(this)"/> <br/>
