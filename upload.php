...
if (isset($_POST["upload"]) && isset($_POST["fileToUpload"]) && validate_alt()) {//NEED VALIDATION FOR ALT DESCRIPTION
    var_dump($_POST["alt_text"]);
    exit;
...
if (!check_image_count($_SESSION['propertyid'])) {//Makes sure that only three images are only uploaded. 
    ...
    echo "Sorry, three images can only be uploaded.";
    $uploadOk = 0;
}
